 ...
 */
class getEntitecollecteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EntitecollecteRepository' shared autowired service.
     *
     * @return \App\Repository\EntitecollecteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EntitecollecteRepository.php';

        return $container->privates['App\\Repository\\EntitecollecteRepository'] = new \App\Repository\EntitecollecteRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
