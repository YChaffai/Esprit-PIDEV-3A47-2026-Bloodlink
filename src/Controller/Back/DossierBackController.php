...
{
   // Vérifiez que vous avez bien ce "use" en haut du fichier :


    #[Route('/', name: 'back_dossier_index', methods: ['GET'])]
    public function index(\App\Repository\DossierMedRepository $dossierMedRepository, DonRepository $donRepo): Response
    {
...
// src/Controller/Back/DossierBackController.php

#[Route('/{id}', name: 'back_dossier_show', methods: ['GET'])]
    public function show(\App\Entity\DossierMed $dossierMed, DonRepository $donRepo, \App\Service\DonorRetentionAIService $aiService): Response
    {
        $historiqueDons = [];
        $nombreDons = 0;
