...
class DossierMed
{
    ...
    #[Assert\Range(min: 50, max: 260, notInRangeMessage: "Taille invalide (50–260 cm).")]
    ...
    #[Assert\Range(min: 10, max: 400, notInRangeMessage: "Poids invalide (10–400 kg).")]
    private ?float $poid = null;

    #[ORM\Column]
    #[Assert\NotNull(message: "La température est obligatoire.")]
    #[Assert\Range(min: 30, max: 45, notInRangeMessage: "Température invalide (30–45 °C).")]
    ...
    #[Assert\Range(min: 100000, max: 999999999999999, notInRangeMessage: "Contact urgence invalide.")]
    ...
    #[Assert\Length(min: 2, max: 255, minMessage: "Le prénom est trop court.")]
    ...
    #[Assert\Range(
        min: 18, 
        max: 120, 
        notInRangeMessage: "L'âge doit être compris entre 18 et 120 ans."
    )]
    private ?int $age = null;

    #[ORM\Column(name: 'type_sang', length: 255)]
    #[Assert\NotBlank(message: "Le groupe sanguin est obligatoire.")]
    #[Assert\Choice(choices: ["A+","A-","B+","B-","AB+","AB-","O+","O-"], message: "Groupe sanguin invalide.")]
    ...
    public function getPoid(): ?float { return $this->poid; }
    public function setPoid(?float $poid): self { $this->poid = $poid; return $this; }
    ...
    public function getContactUrgence(): ?int { return $this->contactUrgence; }
    public function setContactUrgence(?int $contactUrgence): self { $this->contactUrgence = $contactUrgence; return $this; }
    ...
    // ✅ FIX: Added '?' to allow null. 
    // This lets the Assert\NotNull trigger the "Obligatoire" message instead of crashing PHP.
    ...
    public function setTypeSang(?string $typeSang): self { $this->typeSang = $typeSang; return $this; }

    public function getClient(): ?Client { return $this->client; }
    public function setClient(?Client $client): self { $this->client = $client; return $this; }

    public function getDon(): ?Don { return $this->don; }
    public function setDon(?Don $don): self { $this->don = $don; return $this; }
}